    ...
    <div className="bg-[#171D22] text-white">
      <section className="h-screen bg-cover bg-center" style={{
        ...
        <div className="bg-black bg-opacity-50 h-full flex flex-col justify-center items-center text-center">
          ...
          <p className="text-lg md:text-2xl mb-8 max-w-2xl">
            Explore the latest blockbuster movies and your personal favorites – all in one place.
          </p>
      ...
      <section className="py-16 px-8 md:px-44 bg-[#121018] text-center">
        ...
        <p className="text-lg md:text-2xl mb-12">
          Sign up today to get access to the latest movies and personalized recommendations.
        </p>
